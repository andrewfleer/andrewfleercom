...
export default function Resume() {
  return (
    <div className="space-y-8">
      ...
      <section className="bg-white p-8 rounded-lg border-4 border-[#6a0dad] shadow-[8px_8px_0px_0px_#4a0a8d] hover:translate-x-1 hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_#4a0a8d] transition-all">
      ...
      {/* Experience */}
      <section className="bg-white p-8 rounded-lg border-4 border-[#ff1493] shadow-[8px_8px_0px_0px_#c01073] hover:translate-x-1 hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_#c01073] transition-all">
      ...
      <section className="bg-white p-8 rounded-lg border-4 border-[#6a0dad] shadow-[8px_8px_0px_0px_#4a0a8d] hover:translate-x-1 hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_#4a0a8d] transition-all">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-[#6a0dad]/10 p-4 rounded-lg border-2 border-[#6a0dad] shadow-[4px_4px_0px_0px_#4a0a8d] hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_#4a0a8d] transition-all">
